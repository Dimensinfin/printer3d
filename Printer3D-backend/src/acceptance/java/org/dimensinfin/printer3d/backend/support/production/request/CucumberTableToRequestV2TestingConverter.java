...
import org.dimensinfin.printer3d.backend.support.production.request.rest.CustomerRequestRequestV2Testing;
...
public class CucumberTableToRequestV2TestingConverter extends CucumberTableConverter<CustomerRequestRequestV2Testing> {
	...
	@Override
	public CustomerRequestRequestV2Testing convert( final Map<String, String> cucumberRow ) {
		final CustomerRequestRequestV2Testing.Builder builder = new CustomerRequestRequestV2Testing.Builder();
