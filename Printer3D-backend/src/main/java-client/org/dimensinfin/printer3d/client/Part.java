...
// - G E T T E R S   &   S E T T E R S
	...
	/**
	 * It is a human readable label to identify the product. It is a product code but that it usually it is not unique since the same part desing can
	 * be used with different finishings or colours. Cannot be changed for the lifetime of the Part and it is keyed by the user at the front end
	 * interface.
	 *
	 * @return label
	 **/
	...
	public Part active( Boolean active ) {
		this.active = active;
		return this;
	}

	public Part colorCode( ColorCode colorCode ) {
		this.colorCode = colorCode;
		return this;
	}

	public Part cost( Float cost ) {
		this.cost = cost;
		return this;
	}
	...
	public boolean equals( Object o ) {
		...
		return Objects.equals( this.id, part.id ) &&
				Objects.equals( this.label, part.label ) &&
				Objects.equals( this.description, part.description ) &&
				Objects.equals( this.colorCode, part.colorCode ) &&
				Objects.equals( this.cost, part.cost ) &&
				Objects.equals( this.price, part.price ) &&
				Objects.equals( this.active, part.active );
	}
	...
	public Part id( UUID id ) {
		this.id = id;
		return this;
	}

	/**
	 * This flag is used to mark out disabled parts. Parts that are obsolete and no longer should be build are not deleted but just disabled with this
	 * flag. Disable status can be reverted editing the part.
	 *
	 * @return active
	 **/
	...
	public Part label( String label ) {
		this.label = label;
		return this;
	}

	public Part price( Float price ) {
		this.price = price;
		return this;
	}
