...
import { FailureBackendService } from '@app/testing/FailureBackend.service';
...
describe('COMPONENT V3MachineRenderComponent [Module: SHARED]', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            providers: [
                ...
                { provide: FailureBackendService, useClass: FailureBackendService }
            ]
        }).compileComponents();
    ...
    describe('Code Coverage Phase [Methods]', () => {
        ...
        it('startBuild: start the job and process backend exception', async () => {
            jasmine.clock().install();
            const componentAsAny = component as any;
            componentAsAny.backendService = TestBed.get(FailureBackendService)
            console.log('BackendService: ' + componentAsAny.backendService.type)
            componentAsAny.buildTimeTimer = TestBed.createComponent(V1BuildCountdownTimerPanelComponent).componentInstance
            const testPart: Part = new Part({
                id: "9cc43545-3221-4a24-bd0c-04b429d11df4",
                buildTime: 30
            ...
            jasmine.clock().tick(500);
            expect(componentAsAny.backendConnections.length).toBe(1);
            expect(component.state).toBe('EXCEPTION');
            jasmine.clock().uninstall()
        });
        ...
        it('onClear.error: cancel/clear the job and process error', async () => {
            jasmine.clock().install();
            const componentAsAny = component as any;
            componentAsAny.backendService = TestBed.get(FailureBackendService)
            componentAsAny.buildTimeTimer = TestBed.createComponent(V1BuildCountdownTimerPanelComponent).componentInstance
        ...
        it('completeBuild.error: start the job and process error', async () => {
            jasmine.clock().install();
            const componentAsAny = component as any;
            componentAsAny.backendService = TestBed.get(FailureBackendService)
            componentAsAny.buildTimeTimer = TestBed.createComponent(V1BuildCountdownTimerPanelComponent).componentInstance
