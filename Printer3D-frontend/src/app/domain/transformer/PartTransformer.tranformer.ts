...
export class PartTransformer {
    ...
    constructor() {
        ...
        this.columnDefinitions.push(new GridColumn({ headerName: 'Material', field: 'material', sortable: true, width: 90 }));
        this.columnDefinitions.push(new GridColumn({ headerName: 'Color', field: 'color', sortable: true, width: 100 }));
        this.columnDefinitions.push(new GridColumn({ headerName: 'Coste', field: 'coste', sortable: true, width: 80 }))
        this.columnDefinitions.push(new GridColumn({ headerName: 'PVP', field: 'precio', sortable: true, width: 80 }))
        this.columnDefinitions.push(new GridColumn({ headerName: 'Tiempo', field: 'tiempo', sortable: true, width: 90 }))
        this.columnDefinitions.push(new GridColumn({ headerName: 'Stock Rq.', field: 'stockRequerido', sortable: true, width: 100 }))
        this.columnDefinitions.push(new GridColumn({ headerName: 'Stock Disp.', field: 'stockDisponible', sortable: true, width: 100 }))
