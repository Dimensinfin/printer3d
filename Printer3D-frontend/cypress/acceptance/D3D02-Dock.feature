...
Feature: [D3D02]-Test the dock contents and configuration.
    ...
    @D3D02.16
    Scenario: [D3D02.16]-If the user hovers over a hierarchical Feature the list of features changes.
        When there are 9 Features enabled
        When the Feature "/PEDIDOS" is hovered
        When there are 11 Features enabled
