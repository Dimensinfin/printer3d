...
Feature: [D3D20]-[STORY] Describe the contents for the Inventory panel but just related to presentation and accounting.
    ...
    @D3D20.02
    Scenario: [D3D07.02]-Validate the contents of a Model.
    ...
    @D3D20.03
    Scenario: [D3D07.03]-Validate the contents for the Part Group.
    ...
    @D3D20.04
    Scenario: [D3D07.04]-Validate a part when it is not being edited.
    ...
    @D3D20.04
    Scenario: [D3D07.04]-Validate the different color tagging for the Model and Parts states.
        Given the target item the "model" with id "0f789845-cdc6-48ce-a0ce-cbaf63cffab5"
