@D3D05
Feature: [D3D05]-Define the requirements for the Coil creation dialog.

    Added to the list of Parts there is a list of Coils that are also stored at the inventory group endpoint.
    Coils are required for building and define some of the characteristics of the part.
