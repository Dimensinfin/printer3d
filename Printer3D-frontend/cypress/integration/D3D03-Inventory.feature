...
Feature: [D3D03]-Validate the Inventory features and page contents.
    ...
    Scenario: [D3D03.01]-Validate the contents and structure of the Inventory Part List Page.
        ...
        Then there is a "grid-row" at index "1" with the next fields
            | label            | description                                                                                                                                    | buildTime | stockLevel | colours | active |
            | Covid-19 Key - A | Llavero para evitar tocar manillas y pulsadores durante la campaña de Covi-19. Modelo A que es el más simple en un solo color y sin refuerzos. | 60        | 2          | GREEN   | true   |
