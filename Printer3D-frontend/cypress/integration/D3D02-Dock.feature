...
Feature: [D3D02]-Test the dock contents and configuration.
    ...
    Scenario: [D3D02.02]-Check that Features that open Dialogs have a corner in blue.
        ...
        Then the Feature with label "/NUEVO PEDIDO" opens a Dialog
    ...
    Scenario: [D3D02.03]-Validate the elements open when there is a click on each of the Features.
        ...
        When the Feature with label "/PEDIDOS" is clicked the destination is "v1-request-list-page"
    ...
    Scenario: [D3D02.06]-Validate the elements that open a Dialog.
        Given one instance of Dock
        When the Feature with label "/NUEVO ROLLO" is clicked the destination is "new-coil-dialog"
        When the Feature with label "/NUEVA PIEZA" is clicked the destination is "new-part-dialog"
        When the Feature with label "/NUEVO PEDIDO" is clicked the destination is "v1-new-request-dialog"
